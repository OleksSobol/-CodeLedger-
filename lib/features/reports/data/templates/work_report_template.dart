  ...
  pw.Widget _buildContent(WorkReportData data) {
    ...
    for (final date in dates) {
        ...
        pw.Container(
          ...
          child: pw.Row(
            ...
            children: [
              ...
              pw.Text(
                'Day Total: ${fmtDuration(dayTotal)}',
                style: pw.TextStyle(
                  fontWeight: pw.FontWeight.bold,
                  fontSize: 10,
      ...
      for (final e in entries) {
        ...
        final refs = <String>[];
        if (e.repository != null && e.repository!.isNotEmpty)
          refs.add(e.repository!);
        if (e.issueReference != null && e.issueReference!.isNotEmpty)
          refs.add(e.issueReference!);
  ...
  pw.Widget _buildFooter(WorkReportData data) {
    return pw.Row(
      ...
      children: [
        ...
        pw.Text(
          fmtDuration((data.totalHours * 60).round()),
          style: pw.TextStyle(
            fontSize: 14,
            fontWeight: pw.FontWeight.bold,
